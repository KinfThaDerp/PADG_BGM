...
class MapManager:
    def __init__(self, map_widget: tkintermapview.TkinterMapView, parent_view=None):
    ...
    def clear_markers(self, category: str):
        if category in self.markers:
            for marker in self.markers[category].values():
                marker.delete()
            self.markers[category] = {}
            self.display_data[category] = {}
